...
<input type="text" name="InqStrDt" id="InqStrDt" style="width:70px;" class="inputdate vc" value="<%=DateUtil.getDate(DateUtil.getDate("YYYYMMDD", 'W', -1),"YYYYMMDD",'D',1)%>" format="date" maxlength="8" datatype="date" />
