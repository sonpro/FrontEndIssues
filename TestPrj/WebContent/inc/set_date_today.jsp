...
<input type="text" name="InqStrDt" id="InqStrDt" style="width:70px;" class="inputdate vc" value="<%=DateUtil.getDateSimple()%>" format="date" maxlength="8" datatype="date" />
