...
<script type="text/javascript">
    ...
    var  tree = new WebFXTree('입금계좌관리');
    tree.setBehavior('classic');
    
    var a = new WebFXTreeItem("수행기관");
    tree.add(a);
    var b = new WebFXTreeItem("(주) RCMS : 10000000000", "javascript:uf_SetValue('003','10000000000','');");
    a.add(b);
    
    var a = new WebFXTreeItem("인건비");
    tree.add(a);
    var b = new WebFXTreeItem("(주) 가 업체 : 555555555550", "javascript:uf_SetValue('003','555555555550','');");
    a.add(b);
    var b = new WebFXTreeItem("(주) 나 업체 : 888888888880", "javascript:uf_SetValue('003','888888888880','');");
    a.add(b);
    var b = new WebFXTreeItem("(주) 다 업체 : 30030300000", "javascript:uf_SetValue('003','30030300000','');");
    a.add(b);
    
    var a = new WebFXTreeItem("연구시설·장비구입비");
    tree.add(a);
    var b = new WebFXTreeItem("(주) 마 업체 : 222222222220", "javascript:uf_SetValue('003','222222222220','');");
    a.add(b);
    var b = new WebFXTreeItem("(주) 바 업체 : 777777777770", "javascript:uf_SetValue('003','777777777770','');");
    a.add(b);
