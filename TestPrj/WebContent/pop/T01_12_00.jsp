                ...
                <div class="t20 b10">
                 <div class="tab_line"> 
                    <a href="T01_12_30.jsp" class="bt_tab_proof" title="2014년 5월 이후">2014년 5월 이후</a>
      				...
      				<a href="T01_12_00.jsp" class="bt_tab_fix" title="2013년 3월까지">2013년 3월까지</a> 
      				</div>
                </div>
                <!-- //탭버튼//-->
                <!-- (구)증빙가이드라인 가이드 start -->
                <div class="t20 pop_wh">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="(구)증빙가이드라인 증빙가이드" class="tbl_type04">
                    <caption>(구)증빙가이드라인 증빙가이드</caption>
                    <colgroup>
                        <col width="8%" />
                        <col width="14%" />
                        <col width="22%" />
                    ...
                    <tr>
                        ...
                        <td class="ac">외부인건비</td>
                        <td class="ac">지출결의서</td>
                        <td class="ac">계좌이체증빙</td>
                    </tr>
                    <tr>
                        <td rowspan="43">직접비</td>
                        <td rowspan="17">연구시설·장비 및 재료비</td>
                        ...
                        <td rowspan="17">
                            <ul class="pop_tdlist">
                                ...
                                <li>⊙ 검수(설치)완료확인서(계약서 작성에 의해 거래된 경우)</li>
                                <li>⊙ 취득가격이 3,000만원 이상인 연구장비 또는 취득가격이 3,000만원 미만이라도 공동활용이 가능한 연구장비는 국가과학기술종합정보시스템 장비등록서비스(nfec-input.ntis.go.kr)에서 발급받은 '국가연구시설장비정보등 </li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="ac">국내여비</td>
                        <td rowspan="2"><b>[소속기관 자체기준에 따라 여비를 지급하는 경우] </b>
                            <ul class="pop_tdlist t05 b10">
                                <li> ⊙ 품의서(출장자, 기간, 장소, 목적, 여비산출내역, 세부일정(국외의경우) 포함 필수) </li>
                        ...
                        <td rowspan="2"><b>[국내여비]</b>
                            <ul class="pop_tdlist t05">
                                <li>⊙ 근무지외 출장중 숙박이 있는 출장의 경우 출장지 방문 증빙자료</li>
                            </ul>
                            <b>[국외여비]</b>
                            <ul class="pop_tdlist t05">
                                <li>⊙ 출장 보고서 및 결재문서 </li>
                    ...
                    <tr>
                        <td class="ac">인쇄비</td>
                        <td rowspan="21">
                            <p class="b10">⊙ 집행영수증(전자세금계산서, 신용카드매출전표 등)</p>
                            <p> ⊙ 품의서(사전품의에 의한 경우)</p>
                            - 복사비, 수수료, 공공요금 사무용품비, 도서문헌구입비는 품의서 제출 생략가능
                            <p class="t10"> ⊙ 추가 증빙</p>
                            <ul class="pop_tdlist">
                                <li> - 공공요금 : 참여연구원의 참여율을 고려한 산출 내역서 첨부</li>
                                ...
                                <li> - 전문가활용비, 원고료, 번역료, 통역료, 속기료 등 : 특정 전문기관과 계약한 경우 계약서 사본</li>
                            </ul>
                        </td>
                        <td rowspan="21">⊙ 외국환거래계산서 또는 외국환송금내역서(외환거래시) </td>
                    </tr>
                    <tr>
                        <td class="ac">복사비</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><b>[연구관리 전담부서가 있는 비영리기관]</b>
                            ...
                            <b>[그 외(영리기관 등)]</b>
                            <ul class="pop_tdlist">
                                <li>⊙ 집행영수증(전자세금계산서 또는 신용카드매출전표 등)</li>
                                <li>⊙ 거래명세서)</li>
                                <li>⊙ 품의서(사전품의에 의한 경우)</li>
                            </ul>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="pop_tdlist">
                                <li>⊙ 품의서</li>
                                <li>⊙ 위탁연구계약서(계약당사자가 명시된 부분만 제출해도 무방)</li>
                            </ul>
                        </td>
                        <td>⊙ 외국환거래계산서 또는 외국환송금내역서(외환거래시) </td>
                    </tr>
                    </tbody>
                    </table>
                </div>
