...
<body>
  ...
  <div id="content">
    ...
    <div class="t20 b10">
      ...
      <a href="T01_08_00.jsp" class="bt_tab_fix" title="2013년 3월까지">2013년 3월까지</a> 
      </div>
    </div>
    <!-- //탭버튼//-->
    <!-- (구)자계좌이체 허용기준 가이드 start -->
    <div class="pop_wh">
       <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="(구)자계좌이체 허용기준 상세표" class="tbl_type04">
            <caption>
              (구)자계좌이체 허용기준 상세표
              </caption>
            <colgroup>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td rowspan="16" class="ac">연구시설&middot;장비 및 재료비</td>
              ...
              <tr>
                <td rowspan="25" class="ac">연구활동비</td>
                <td class="ac">국내여비</td>
                <td class="ac">가능</td>
              </tr>
              <tr>
    ...
    <!-- //(구)자계좌이체 허용기준 가이드 end// -->
    <p class="t10 txt_or b b20">※ 상황별 허용 : 허용비목, 외자구매, 협약전사용금액, 연구비잔액부족, 지체보상금제외이체, 지로직접납부, 자계좌이체 승인기관</p>
    <h3>상황별 허용</h3>
    <!-- 자계좌이체 허용기준 리스트 start -->
    <div class="t10 pop_wh">
      <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="자계좌이체 허용기준 리스트" class="tbl_type04">
        <caption>
          자계좌이체 허용기준 리스트
          </caption>
        <colgroup>
        ...
        <thead>
          <tr>
            <th scope="col" rowspan="2">집행종류구분</th>
            <th scope="col" colspan="2" >가능여부</th>
        ...
        <tbody>
          <tr>
            <td rowspan="14" class="ac">자계좌이체 허용비목(Guideline 참조)</td>
            <td rowspan="19" class="ac">전자세금계산서 카드증빙 기타증빙</td>
            <td class="ac">내부인건비</td>
            <td rowspan="3">자계좌이체 후 내부기준에 따라 지급</td>
          </tr>
          <tr>
            <td class="ac">외부인건비</td>
          </tr>
          ...
          <tr>
            <td class="ac txt_or">간접비</td>
            <td class="txt_or">비영리기관인경우만 해당</td>
          </tr>
          <tr>
            <td class="ac">국내여비</td>
            <td rowspan="3">자계좌이체 후 내부기준에 따라 지급</td>
          ...
          <tr>
            ...
            <td rowspan="4">일괄구매로 집행된 경우에 한해 허용</td>
          </tr>
          <tr>
            <td class="ac">사무용품비</td>
          </tr>
          ...
          <tr>
            ...
            <td>MRO 구매인 경우에 한해 허용하며 관련 증빙 필수</td>
          </tr>
          <tr>
            <td class="ac">외자구매</td>
