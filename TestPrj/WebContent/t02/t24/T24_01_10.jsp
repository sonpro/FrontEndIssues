...
/* ********************** 2014 그리드 교체 작업 rMateGrid setting START *********************** */
 ...
 <DataGrid id=\"grid1\" lockedColumnCount=\"1\" styleName=\"gridStyle\" horizontalScrollPolicy=\"auto\" sortableColumns=\"false\" draggableColumns=\"true\" selectionMode=\"singleRow\" headerHeight=\"24\" doubleClickEnabled=\"true\" displayItemsExpanded=\"false\">\
	 ...
	 <DataGridColumn id=\"EXCTN_EXEC_DT\"           dataField=\"EXCTN_EXEC_DT\"               headerText=\"사용일자\"       width=\"90\"  visible=\"true\" textAlign=\"center\" headerStyleName=\"gridHeaderStyle\" />\
	 ...
	 <DataGridColumn id=\"RCV_ACCT_BNK_CD\"         dataField=\"RCV_ACCT_BNK_CD\"             headerText=\"입금은행\"       width=\"110\" visible=\"true\" textAlign=\"center\" headerStyleName=\"gridHeaderStyle\" />\
	 ...
	 <DataGridColumn id=\"RCV_ACCT_OWAC_NM\"        dataField=\"RCV_ACCT_OWAC_NM\"            headerText=\"수취인\"         width=\"110\" visible=\"true\" textAlign=\"center\" headerStyleName=\"gridHeaderStyle\" />\
	 <DataGridColumn id=\"TRNS_AMT\"                dataField=\"TRNS_AMT\"                    headerText=\"이체금액\"       width=\"80\"  visible=\"true\" textAlign=\"right\" headerStyleName=\"gridHeaderStyle\" formatter=\"{numfmt}\" sortCompareFunction=\"numeric\" />\
        ...
        try{            
			...
			<%for(int i=0; i<ExctnExecDt.length; i++){%> 			    
	            ...
	            {            	
	            	...
	            	"RCV_ACCT_BNK_CD":"<%=CodeUtil.getCode("BNK_CD",StringUtil.null2void(RcvAcctBnkCd[i]))%>",
	            	"RCV_ACCT_NO":"<%=StringUtil.null2void(AcctFormatUtil.getAcctForm(RcvAcctNo[i], RcvAcctBnkCd[i]))%>",
	            	"RCV_ACCT_OWAC_NM":"<%=StringUtil.null2void(RcvAcctOwacNm[i])%>",
	            	...
	            	"USE_VAT_AMT":"<%=FormatUtil.getMoneyForm(StringUtil.null2void(UseVatAmt[i]))%>"
	            };          
	        <%}%>
